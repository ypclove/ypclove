...
## 技术栈 👨‍💻
### 后端 🔭
JavaWeb、Maven、Spring、MyBatis、MyBatis-Plus、SpringBoot、Spring Gateway、SpringCloud、RabbitMq、Nacos、Docker、分布式搜索、Elasticsearch、设计模式、JMeter压力测试、Nginx
